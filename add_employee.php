...
if(isset($_POST['submit'])){
	...
	$prénom=mysqli_real_escape_string($con,$_POST['prénom']);
	...
	if($id>0){
		$sql="update employee set name='$name',prénom='$prénom,email='$email',mobile='$mobile',password='$password',address='$address',birthday='$birthday' where id='$id'";
	}else{
		$sql="insert into employee(name,prénom,email,mobile,password,address,birthday,role) values('$name','$prénom,$email','$mobile','$password','$address','$birthday','2')";
	}
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>ajouter salariés</strong><small> Form</small></div>
                           ...
                           <form method="post">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" value="<?php echo $prénom?>" name="prénom" placeholder="Enter employee prénom" class="form-control" required>
								</div>
								<div class="form-group">
